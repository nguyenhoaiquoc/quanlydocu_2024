<x-layout>
    ...
    <div class="container mt-4">
        <h2 class="section-title" id="khamphangay">📦 Tất cả sản phẩm</h2>
        @php
            $q = request('q');
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <ul class="products">
                    ...
                    @empty
                        <p class="text-muted">Không có sản phẩm nào được duyệt.</p>
                    @endforelse
                </ul>
            ...
            {{-- Bên phải: Thanh tìm kiếm & lọc giá --}}
            <div class="col-md-3">
                <div class="card shadow-sm p-3 mb-3 bg-white rounded">
                    <h5 class="mb-3">🔎 Tìm kiếm & Lọc</h5>

                    <form action="{{ route('products.all-product') }}" method="GET">
                        <div class="mb-2">
