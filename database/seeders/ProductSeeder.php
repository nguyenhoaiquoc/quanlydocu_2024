...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            'location_primary' => 'TDC Thủ Đức',
            'location_secondary' => 'KTX khu B',
            'condition' => 'đang bán',
            'is_approved' => 1
            , // nếu cần duyệt luôn   
        ...
        DB::table('products')->insert([
            ...
            <li>HỆ THỐNG CAMERA PRO MẠNH MẼ — Sở hữu khung hình linh hoạt đáng kinh ngạc với 7 ống kính chuyên nghiệp. Chụp ảnh có độ phân giải siêu cao với nhiều màu sắc và chi tiết hơn bằng camera Chính 48MP. Và chụp ảnh cận cảnh sắc nét hơn từ khoảng cách xa hơn với camera Teleimage 5x trên iPhone 15 Pro Max.</li>
        ...
        DB::table('products')->insert([
            ...
            <p>Công nghệ Samsung S23&nbsp;giúp người dùng khám phá những điều thú vị từ bầu trời đêm vô tận một cách dễ dàng. Các nhà sáng tạo chuyên nghiệp của Samsung&nbsp;đã tích hợp bộ công cụ chuyên biệt hóa trải nghiệm chụp ảnh. Theo đó, tại&nbsp;ứng dụng Expert RAW, người dùng có thể chụp ảnh với chất lượng cao, nhiều chi tiết. Kết hợp với tính năng Astroimage (Chụp thiên văn), giúp&nbsp;phóng to tới các vì sao và hành tinh của bạn. Hãy trải nghiệm và tận hưởng những khung hình thú vị, sắc nét từ ngân hà trong đêm.</p>
